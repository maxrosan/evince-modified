...
static void     ev_window_popup_cmd_find_dict           (GSimpleAction    *action,
							 GVariant         *parameter,
							 gpointer          user_data);
...
static void     ev_window_popup_cmd_find_dict_leo    (GSimpleAction    *action,
							 GVariant         *parameter,
							 gpointer          user_data);
...
ev_window_update_actions_sensitivity (EvWindow *ev_window)
{
	...
	ev_window_set_action_enabled (ev_window, "find-dictionary",
					has_pages &&
					ev_view_get_has_selection (view) &&
					!recent_view_mode);
			   ...
			   EvWindow *window)
{
	...
	ev_window_set_action_enabled (window, "find-dictionary",
					ev_view_get_has_selection (view));
}
...
static const GActionEntry actions[] = {
	...
	{ "find-dictionary-leo", ev_window_popup_cmd_find_dict_leo },
...
static void
ev_window_popup_cmd_find_dict_leo (GSimpleAction *action,
			       GVariant      *parameter,
			       gpointer       user_data)
{
	EvWindow *window = user_data;

	ev_view_find_dict_leo(EV_VIEW (window->priv->view));
}

static void
ev_window_popup_cmd_find_dict (GSimpleAction *action,
			       GVariant      *parameter,
			       gpointer       user_data)
{
	EvWindow *window = user_data;
